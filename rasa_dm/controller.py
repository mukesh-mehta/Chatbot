...
from rasa_dm.actions.action import ActionListen, ActionRestart
from rasa_dm.channels.direct import CollectingOutputChannel
from rasa_dm.dispatcher import Dispatcher
from rasa_dm.domain import Domain
from rasa_dm.events import Restart
from rasa_dm.events import UserUtterance, ExecutedAction
from rasa_dm.interpreter import NaturalLanguageInterpreter
from rasa_dm.interpreter import RegexInterpreter
from rasa_dm.channels import UserMessage, InputChannel
from rasa_dm.policies.ensemble import PolicyEnsemble
from rasa_dm.tracker_store import TrackerStore
...
class MessageProcessor(object):
    ...
    def _run_action(self, action, tracker, dispatcher):
        ...
        logger.info("Running action '{}' with latest intent '{}'".format(
            action.name(), tracker.latest_message.intent))

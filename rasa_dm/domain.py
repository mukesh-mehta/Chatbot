...
from rasa_dm.actions import DefaultTopic
from rasa_dm.actions.action import ActionListen, UtterAction, ActionRestart
from rasa_dm.conversation import Topic
from rasa_dm.events import ExecutedAction
from rasa_dm.featurizers import Featurizer
from rasa_dm.slots import Slot
from rasa_dm.trackers import DialogueStateTracker, SetSlot
from rasa_dm.util import lazyproperty, create_dir_for_file, class_from_module_path
...
class Domain(with_metaclass(abc.ABCMeta, object)):
    ...
    def training_data_from_stories(self, featurizer, stories, max_history, should_remove_duplicates):
        ...
        from rasa_dm.channels import UserMessage

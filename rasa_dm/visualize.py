...
from rasa_dm.training_utils import create_stories_from_file
from rasa_dm.training_utils.visualization import visualize_stories
...
def create_argparser():
    ...
    parser.add_argument('-nlu', '--nlu_data', default=None,
                        help="path of the Rasa NLU training data, used to insert example messages into the graph")
    return parser

...
from rasa_dm.channels.channel import UserMessage
from rasa_dm.channels.channel import InputChannel, OutputChannel
from rasa_dm.util import bcolors, print_color
...
class ConsoleInputChannel(InputChannel):
    ...
    def _record_messages(self, on_message, max_message_limit=None):
        print_color("Bot loaded. Type a message and press enter : ", bcolors.OKGREEN)
        num_messages = 0
